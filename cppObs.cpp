// This Rcpp function generates the observed path every time dt
// Returns: sx: x-coordinates observed
//          sy: y-coordinates observed
//          st: times of the obervation
#include <Rcpp.h>
